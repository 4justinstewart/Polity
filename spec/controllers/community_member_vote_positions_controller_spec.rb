...
describe CommunityMemberVotePositionsController do
  ...
  # CommunityMemberVotePosition. As you add validations to CommunityMemberVotePosition, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "agree" => "false" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # CommunityMemberVotePositionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
