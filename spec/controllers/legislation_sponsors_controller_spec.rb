...
#   # LegislationSponsor. As you add validations to LegislationSponsor, be sure to
#   # adjust the attributes here as well.
#   let(:valid_attributes) { { "sponsor_id" => "1" } }

#   # This should return the minimal set of values that should be in the session
#   # in order to pass any filters (e.g. authentication) defined in
#   # LegislationSponsorsController. Be sure to keep this updated too.
#   let(:valid_session) { {} }
...
#         post :create, {:legislation_sponsor => { "sponsor_id" => "invalid value" }}, valid_session
#         assigns(:legislation_sponsor).should be_a_new(LegislationSponsor)
#       end
...
#         LegislationSponsor.any_instance.should_receive(:update).with({ "sponsor_id" => "1" })
#         put :update, {:id => legislation_sponsor.to_param, :legislation_sponsor => { "sponsor_id" => "1" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         LegislationSponsor.any_instance.stub(:save).and_return(false)
#         put :update, {:id => legislation_sponsor.to_param, :legislation_sponsor => { "sponsor_id" => "invalid value" }}, valid_session
#         assigns(:legislation_sponsor).should eq(legislation_sponsor)
#       end
