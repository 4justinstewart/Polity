...
describe "community_supports/edit" do
  before(:each) do
  ...
  it "renders the edit community_support form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", community_support_path(@community_support), "post" do
